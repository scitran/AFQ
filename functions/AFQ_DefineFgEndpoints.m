...
if nFG == 20 && (~exist('startpoint','var') || isempty(startpoint)) && ...
    ...
    startpoint = {[]                 , []                  , ...
                  'cstinferior'      , 'cstinferior'       , ...
                  'leftcingpost'     , 'rightcingpost'     , ...
                  []                 , []                  , ...
                  'leftoccipital'    , 'leftfrontal'       , ...
                  'leftoccipital'    , 'rightoccipital'    , ...
                  'leftoccipital'    , 'rightoccipital'    , ...
                  'leftinfparietal'  , 'rightinfparietal'  , ...
                  'leftanttemporal'  , 'rightanttemporal'  , ...
                  'leftfrontal'      , 'rightfrontal'      };
    endpoint   = {'leftfrontal'      , 'rightfrontal'      , ...
                  'cstsuperior'      , 'cstsuperior'       , ...
                  []                 , []                  , ...
                  []                 , []                  , ...
                  'rightoccipital'   , 'rightfrontal'      , ...
                  'leftifoffront'    , 'rightifoffront'    , ...
                  'leftilftemporal'  , 'rightilftemporal'  , ...
                  'leftslffront'     , 'rightslffront'     , ...
                  'leftuncinatefront', 'rightuncinatefront',...
...
for jj = 1:nFG
    ...
    % Get the numbers of the regions that define the desired ROI
    % in the AAL template
