function [status, results] = AFQ_mrtrix_maskfilter(brainmask, ...
                                                   dilated, ...
                                                   eroded, ...
                                                   verbose, ...
                                                   mrtrixVersion)
...
if mrtrixVersion == 3
    ...
    cmd_str1         = ['maskfilter -force ' brainmask  ' ' ...
                        'dilate - | mrthreshold -force -abs 0.5 - ' dilated];
    cmd_str2         = ['maskfilter -force ' brainmask  ' ' ...
                        '-npass 2 erode - | mrthreshold -force -abs 0.5 - ' eroded];
